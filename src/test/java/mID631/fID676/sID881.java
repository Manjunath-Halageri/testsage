...
public class manju extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new LoginPage(driver).uname,"unameValue");
        ...
        try
        {
            actions.EnterData(new LoginPage(driver).password,"passwordValue");
        ...
        try
        {
            actions.Click(new LoginPage(driver).buttonobj5);
