...
public class samt extends  AllActions {
...
double test4=33.33;
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new LoginPage(driver).uname,"hfhfg");
        ...
        try
        {
            actions.EnterData(new LoginPage(driver).password,"manju");
